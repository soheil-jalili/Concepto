...
const MainFooter = () => {
  const footer_links = useSelector(
    (state: RootState) => state.home.footer_link_main
  );
      ...
      <div className="bg__footer max-[368px]:!h-auto" id="footer__wrapper">
        <div className="container min-[2900px]:h-[300px]">
          <div className="grid grid-cols-1 xl:grid-cols-[664px_1fr] gap-x-20">
            ...
            <div className="mt-32 md:mt-30 md:flex md:flex-col-reverse md:gap-10 xl:block">
              ...
              <div className="grid grid-cols-2 gap-y-6 md:grid-cols-3 mb-9 justify-between">
                {footer_links.map(
                  (footer: {
                    ...
                    return (
                      <div className="text-white" key={footer.id}>
            ...
            {/* <!-- Right Section Footer --> */}
            <div className="md:mt-20 xl:mt-30">
              {/* <!-- New News --> */}
